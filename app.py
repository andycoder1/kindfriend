...
STRIPE_PRICE_ID = os.getenv("STRIPE_PRICE_ID", "")  # recurring price id (price_***)
...
def _require_stripe_ready():
    if not stripe or not STRIPE_SECRET_KEY or not STRIPE_PRICE_ID or not BILLING_RETURN_URL:
